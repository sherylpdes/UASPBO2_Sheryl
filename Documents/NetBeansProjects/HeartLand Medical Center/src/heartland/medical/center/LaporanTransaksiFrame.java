 ...
 * @author acer
 */
public class LaporanTransaksiFrame extends javax.swing.JFrame {
     ...
     */
    public LaporanTransaksiFrame() {
        initComponents();
        model = new DefaultTableModel();
        tbllaptrans.setModel(model);
        model.addColumn("No Reff");
    ...
    public final void loadData() {
        ...
        try {
            ...
            while (r.next()) {
                ...
                o[0] = r.getString("no_reff");
                o[1] = r.getString("no_rm");
                o[2] = r.getString("nama_pasien");
                o[3] = r.getString("kode_poli");
                o[4] = r.getString("nama_poli");
                o[5] = r.getString("nama_dokter");
                o[6] = r.getString("jenis_biaya");
                o[7] = r.getString("jumlah_biaya");
                o[8] = r.getString("bayar");
                o[9] = r.getString("kembali");
                o[10] = r.getString("tanggal");
                model.addRow(o);
            }
            r.close();
            s.close();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tbllaptrans);
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
        ...
        try {
            Connection c = Koneksi.getKoneksi();
            Statement s = c.createStatement();
            String sql = "select * from tbl_transaksi where no_reff like '%" + txtsearch.getText() + 
                    "%' or no_rm like'%" + txtsearch.getText() + "%'or nama_pasien like'" + txtsearch.getText() + 
                    "%' or kode_poli like'%" + txtsearch.getText() + "%' or nama_poli like'" + txtsearch.getText()
                    + "%' or nama_dokter like'" + txtsearch.getText() + "%' or jenis_biaya like'" + txtsearch.getText() 
                    + "%' or jumlah_biaya like'" + txtsearch.getText() + "%' or bayar like'" + txtsearch.getText()
                    + "%' or kembali like'" + txtsearch.getText() + "%' or tanggal like'" + txtsearch.getText() + "%'";
            ResultSet r = s.executeQuery(sql);
            while (r.next()) {
                Object[] o = new Object[11];
                o[0] = r.getString("no_reff");
    ...
    private void btnprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprintActionPerformed
        // TODO add your handling code here:
        try{
            Desktop.getDesktop().browse(new URL("http://localhost/RumahSakit/LaporanTransaksi.php?laptrans=").toURI());
        } catch (Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanTransaksiFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanTransaksiFrame().setVisible(true);
            }
        });
    }
